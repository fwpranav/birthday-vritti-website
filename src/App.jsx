...
function App() {
  ...
  return (
    <div className="app">
      ...
      <div
        ref={page1Ref}
        className={`page page--countdown ${currentPage === 1 ? "active" : ""}`}
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Vritti</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Vritti's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
      ...
      <div
        ref={page2Ref}
        className={`page page--celebration ${currentPage === 2 ? "active" : ""}`}
      ...
      <div
        ref={page3Ref}
        className={`page page--message ${currentPage === 3 ? "active" : ""}`}
      ...
      <div
        ref={page4Ref}
        className={`page page--gallery ${currentPage === 4 ? "active" : ""}`}
      ...
      >
        ...
        <section className="final">
          ...
          <p className="final-subtitle">Thank you for being  ✨</p>
        </section>
      </div>
